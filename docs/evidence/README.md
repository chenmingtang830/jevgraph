...
The v0.5.1 release evidence bundle contains the controlled direct relation-selection aggregate plus sanitized raw
...
`direct-reasoning-none-2026-09-20.json` is the v0.5.1 primary result: chat requests use explicit
