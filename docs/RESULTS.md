...
Status: v0.4.1 controlled direct relation-selection benchmark completed on 2026-09-20.
...
## v0.4.1 primary: chat reasoning disabled
...
but are superseded for the primary comparison by the controlled v0.4.1 table.
